...
php7.4-mysql php7.4-pgsql php7.4-sqlite3 php7.4-soap \
php7.4-json php7.4-curl php7.4-gd \
php7.4-gmp php7.4-imap php-xdebug \
php7.4-mbstring php7.4-zip \
php-pear php-apcu php-memcached php-redis \
php7.4-dom php7.4-bcmath
...
echo "xdebug.remote_port = 9000" >> /etc/php/7.4/fpm/conf.d/20-xdebug.ini
echo "xdebug.var_display_max_depth = -1" >> /etc/php/7.4/fpm/conf.d/20-xdebug.ini
echo "xdebug.var_display_max_children = -1" >> /etc/php/7.4/fpm/conf.d/20-xdebug.ini
echo "xdebug.var_display_max_data = -1" >> /etc/php/7.4/fpm/conf.d/20-xdebug.ini
echo "xdebug.max_nesting_level = 500" >> /etc/php/7.4/fpm/conf.d/20-xdebug.ini
